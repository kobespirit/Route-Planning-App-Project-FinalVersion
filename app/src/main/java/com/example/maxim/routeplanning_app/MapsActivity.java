...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, PlaceSelectionListener {
    ...
    public void onMapReady(GoogleMap map) {
        ...
        //LatLng sydney = new LatLng(-37.813, 144.962);
        //map.addMarker(new MarkerOptions().position(sydney).title("Melbourne Area"));
    ...
    private void showMaker(LatLng point) {
    ...
    private void build_retrofit_and_get_response(String type) {
        ...
        if (origin == null || dest == null) {
            Toast.makeText(this, "Please search or click two places on the map.",
    ...
    public void onPlaceSelected(Place place) {
        ...
        showMaker(point);
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(point, 15.5f), 2000, null);
    }
